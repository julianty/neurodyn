...
anneal1.save_paths("neurodyn/paths_%d.npy" % (initID)) #state paths
anneal1.save_params("neurodyn/params_%d.npy" % (initID))
anneal1.save_action_errors("neurodyn/action_errors%d.npy" % (initID))#saves action and constituent errors

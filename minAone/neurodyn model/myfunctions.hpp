...
double Alphasplinejac(double V, int x, int n)
{
  ...
  if(n==1){
    ...
    // need this multiplier for the chain rule
    return 0.7 / 0.0126 * alpha;
  }
  else if(n==2){
    return 0;
  }
...
double Alphasplinehes(double V, int x, int n, int m)
{
  ...
  if(m==1){ 
	...
	if(x == 3){
      ...
      return (0.7 / 0.0126) * (0.7 / 0.0126) * alpha;
    }
    else if(n==2){
      return 0;
    }
...
double Betasplinehes(double V, int x, int n, int m)
{
  ...
  if(m==1){
	...
	if(x == 3){
      ...
      return (0.7 / 0.0126) * (0.7 / 0.0126) * beta;
    }
    else if(n==2){
      return 0;
    }
